...
""" % (convert_event(controller_mapping['Top 1'], 100), 
    convert_event(controller_mapping['Top 2'], 99),
 convert_event(controller_mapping['Top 3'], 115), 
 convert_event(controller_mapping['Bottom 1'], 120), 
 convert_event(controller_mapping['Bottom 2'], 97),
 convert_event(controller_mapping['Bottom 3'], 102), 
 convert_event(controller_mapping['START'], 13), 
 convert_event(controller_mapping['COIN'], 9),
